...
If you want to test the app you'll need to have some GoerliETH to cover the transaction fees. In order to get some free GoerliETH you can use any faucets available online.
